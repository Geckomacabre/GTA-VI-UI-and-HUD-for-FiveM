/* -----------------------------------------------------------------------------
   vice_hud theme receiver for qb-menu   (added by vice_hud; safe to delete)
   -----------------------------------------------------------------------------
   ...
   qb-menu's page has stable, hand-written class names, so the stylesheet
   targets them directly and there is nothing to discover at runtime.

   qb-menu's own script.js switches on `event.data.action` and returns on an
