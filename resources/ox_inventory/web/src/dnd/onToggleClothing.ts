...
/**
 * Mirrors um_clothing's live ped state (GetClothingWheelState export), not
...
/** Clicking a mask/hat/eyewear wheel cell toggles it via um_clothing and re-reads the new state. */
